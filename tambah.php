    	...
    	<div id="wrapper">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <input type="number" name="phone" class="form-control" id="phone" required="" placeholder="Enter phone number">
            </div>
             <div class="form-group">
             ...
             <div class="form-group">
              ...
              <select class="form-control" id="role" placeholder="Masukkan Role Pengguna" name="role" required="">
